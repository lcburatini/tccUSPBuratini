...
def graficoFrequencia2(obs,titulo,xtitulo,ytitulo):
    # Estilo visual
    sns.set(style="whitegrid")
    plt.figure(figsize=(10, 6))
...
def graficoFrequencia(obs, titulo, xtitulo, ytitulo):
    # Estilo minimalista, sem fundo nem grade
    sns.set(style="white")  

    plt.figure(figsize=(10, 6))

    # Histograma apenas com contorno (sem preenchimento)
    sns.histplot(obs, bins=30, kde=True, edgecolor="black", color='green',fill=False)

    # Títulos e rótulos com fonte Arial
    plt.title(titulo, fontsize=16, fontweight='bold', fontname="Arial")
    plt.xlabel(xtitulo, fontsize=14, fontname="Arial")
    plt.ylabel(ytitulo, fontsize=14, fontname="Arial")
